...
auto handle_options(int argc, char* argv[])
{
  ...
  ("pop", bpo::value<std::string>()->default_value("10000"), "Population sizes are defined by a single numerical constant,or a string which specifies thebpopulation size on each branch. The string can be input through command line or a file. By default, population size 10,000 is used.")
  ("mm", bpo::value<std::string>(), "Multiple merger parameters are defined by a single numerical constant, or a string which speifies the parameter on each branch. The string can be input through command line or a file. By default, Kingman coalescent is used.")
